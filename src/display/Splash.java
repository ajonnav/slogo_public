...
public class Splash extends Screen {
    ...
    public void setUpScene () {
        getRoot().getStylesheets().add(ResourceConstants.DEFAULT_RESOURCE + ResourceConstants.SPLASH_CSS);
    ...
    private void setLangBox () {
        ObservableList<String> options = FXCollections.observableArrayList(
                                                                           getResources()
                                                                                   .getString(ResourceConstants.CHIN),
                                                                           getResources()
                                                                                   .getString(ResourceConstants.ENG),
                                                                           getResources()
                                                                                   .getString(ResourceConstants.FRA),
                                                                           getResources()
                                                                                   .getString(ResourceConstants.GER),
                                                                           getResources()
                                                                                   .getString(ResourceConstants.ITA),
                                                                           getResources()
                                                                                   .getString(ResourceConstants.POR),
                                                                           getResources()
                                                                                   .getString(ResourceConstants.RUS),
                                                                           getResources()
                                                                                   .getString(ResourceConstants.SPA));
        ...
        languageCBox.setValue(getResources().getString(ResourceConstants.ENG));
